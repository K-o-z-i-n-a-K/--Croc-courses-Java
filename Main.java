...
public class Main {
    ...
    public static String StartP() {
        ...
        if (NumDevice == 1){
            System.out.print(" 2 - CD плеер ");
        }
        if (NumDevice == 2){
            System.out.println(" 2 - колонки ");
        }
        if (NumDevice == 3){
    ...
    public static String StartM() {
        ...
        for(int i = 0; i < groups[NumDevice-1].length; i++){
            System.out.println(i+1 + " " + groups[NumDevice-1][i][0]);
        }
        n2 = sc.nextInt();

        if (n2 < 1 || n2 > groups[NumDevice-1].length){
            System.out.print( "\u001B[31m" + "Нет такого варианта.  \n" + "\u001B[0m");
            StartM();
        }
    ...
    public static String StartS() {
        ...
        for(int i = 1; i < groups[NumDevice-1][n2-1].length; i++){
